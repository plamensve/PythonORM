...
#     products = Product.objects.annotate(Sum('orderproduct__quantity')).values()
#     result = []
#     for p in products:
#         if p['orderproduct__quantity__sum'] is not None:
#             result.append(f"Quantity ordered of {p['name']}: {p['orderproduct__quantity__sum']}")
#
